...
public class Authentification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //google
        signInGoogleBtn = (SignInButton)findViewById(R.id.googleBtn);
        ...
        mGoogleSignInClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener(){
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(Authentification.this, "Erreur !", Toast.LENGTH_SHORT).show();
                    }
                })
        ...
        loginFbBtn = (LoginButton) findViewById(R.id.facebookBtn);
        loginFbBtn.setReadPermissions("email", "public_profile");
        loginFbBtn.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            @Override
